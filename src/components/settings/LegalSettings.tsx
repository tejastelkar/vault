...
export function LegalSettings() {
  ...
  if (activePolicy === "privacy") {
    return (
      <section className="settings-detail-section animate-in slide-in-from-right-4 fade-in duration-200">
        <header className="flex items-center gap-2 mb-6">
          <button 
            onClick={() => setActivePolicy(null)}
            className="w-8 h-8 flex items-center justify-center rounded-full hover:bg-secondary/50 text-muted-foreground hover:text-foreground transition-colors -ml-2"
            aria-label="Go back"
          >
  ...
  return (
    <section className="settings-detail-section animate-in fade-in duration-200" aria-labelledby="settings-legal-title">
      <header>
      ...
      <div className="apple-grouped-list">
        ...
        <button
          ...
          className="settings-control-row w-full text-left bg-transparent border-0 cursor-pointer system-interactive select-none hover:bg-secondary/40 transition-colors"
        >
